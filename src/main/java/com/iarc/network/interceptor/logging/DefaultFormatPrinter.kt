package com.iarc.network.interceptor.logging

import android.text.TextUtils
import com.iarc.network.interceptor.logging.LogInterceptor.Companion.isJson
import com.iarc.network.interceptor.logging.LogInterceptor.Companion.isXml
import com.iarc.network.utils.CharacterHandler.Companion.jsonFormat
import com.iarc.network.utils.CharacterHandler.Companion.xmlFormat
import com.iarc.network.utils.NetworkLogUtils
...
class DefaultFormatPrinter : FormatPrinter {
    ...
    override fun printJsonRequest(
        ...
        val tag = getTag(true)
        NetworkLogUtils.debugInfo(tag, REQUEST_UP_LINE)
        logLines(
            tag,
        ...
        NetworkLogUtils.debugInfo(tag, END_LINE)
    }
    ...
    override fun printJsonResponse(
        ...
        NetworkLogUtils.debugInfo(tag, RESPONSE_UP_LINE)
